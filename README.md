...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-28 20:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0b3e0b99-21cc-4c24-a352-c2ac0b064405.git
$ cd 0b3e0b99-21cc-4c24-a352-c2ac0b064405
```
